...
export RUN_NAME=modelscopet2v_extract_code_16  # name of the run
...
accelerate launch --num_machines 1 --num_processes $GPUS \
    ...
    --extract-code-dir /home/shaoshitong/extract_code_dir_scope_16/ \
    --web-dataset-end 80 \
    --web-dataset-begin 75 \
    --prev_train_unet /home/shaoshitong/project/mcm/work_dirs/modelscopet2v_distillation_15/checkpoint-final

export VIDEO_DATA_PATH=/path/to/video/data
export GPUS=8  # number of GPUs
export MASTER_PORT=29504  # port for distributed training
export RUN_NAME=modelscopet2v_distillation_16 # name of the run
