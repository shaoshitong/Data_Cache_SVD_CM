...
export RUN_NAME=modelscopet2v_distillation_3  # name of the run
export DIS_RUN_NAME=modelscopet2v_discriminator_2 # name of the run
...
accelerate launch --num_machines 1 --num_processes $GPUS \
    ...
    --lr_warmup_steps 500 --scheduler_last_step 2000 \
