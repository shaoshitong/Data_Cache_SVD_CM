...
def parse_args():
    ...
    parser.add_argument(
        "--extract-code-dir", default="./extract_code_dir", type=str, help="where to save the data cache"
    )
    parser.add_argument(
        "--web-dataset-begin", default=0, type=int, help="the begin index for extracting dataset to cache"
    )
    parser.add_argument(
        "--web-dataset-end", default=5, type=int, help="the end index for extracting dataset to cache"
    )
    parser.add_argument(
        "--discriminator-checkpoint", default="./checkpoint/pretrain_discriminator_m_imagenet_code42/discriminator.pth.tar", type=str, help="the checkpoint path of discriminator pre-trained from ImageNet-1k"
    )
    parser.add_argument(
        "--dis_output_dir", default="./", type=str, help="the checkpoint path of discriminator fine-tuned for finetune_discriminator_m.py"
    )
...
if __name__ == "__main__":
    ...
    print(alpha_schedule,sigma_schedule)